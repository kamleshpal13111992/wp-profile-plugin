...
class Wp_Profile_Listing {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-profile-listing-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-profile-listing-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wp-profile-listing-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wp-profile-listing-public.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'save_post', $plugin_admin, 'save_profile_meta_data');
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_custom_profile_search', $plugin_public , 'custom_profile_search');
		$this->loader->add_action( 'wp_ajax_nopriv_custom_profile_search', $plugin_public , 'custom_profile_search');
		$this->loader->add_action( 'wp_ajax_nopriv_custom_profile_search', $plugin_public , 'custom_profile_search');
	}
